        ...
        <div className="container-xxl">
          <a href="#" className="navbar-brand">
            <span className="fw-bold text-light">
              <i className="bi bi-person-circle"></i> PORTFOLIO
            </span>
          </a>
          <button
            ...
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <Link to="/upload" className="nav-link">
                  <i className="bi bi-upload d-none d-md-inline"></i> Uploads
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/contact" className="nav-link">
                  <i className="bi bi-telephone-inbound-fill d-none d-md-inline"></i>{" "}
                  Contact
                </Link>
              </li>
              ...
              <li className="nav-item ms-2 mt-1 d-none d-md-inline ">
                <Link to="/projects" className="btn btn-md btn-warning fw-bold">
                  <i className="bi bi-person-workspace d-none d-md-inline"></i>{" "}
                  Projects
                </Link>
              </li>
